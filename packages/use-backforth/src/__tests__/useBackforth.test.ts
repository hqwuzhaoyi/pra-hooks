...
describe('useBackforth', () => {
  ...
  it('should work without no initial ', () => {
    const { result, rerender } = renderHook(() =>
      useBackforth(document.getElementById('container') as HTMLElement),
    );
    ...
    expect(
      (document.getElementById('container') as HTMLElement).style.transform,
